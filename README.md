...
| Language server            | `bylaws-lsp` with checks on unsaved changes                 | None                                                                 | None                                           |
| Editor support             | Clients for VS Code, Cursor, Zed, Neovim and Emacs          | Test diagnostics in Xcode                                            | Xcode integration and external editor clients  |
